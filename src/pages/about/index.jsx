        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 py-12 max-w-6xl">
          <div className="max-w-full sm:max-w-xl md:max-w-2xl">
            <div className="p-4 sm:p-6">
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">Our Farm</h2>
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4 mt-4 sm:mt-6">Our Mission</h2>
